...
export const DIETARY_TAG_GROUPS: { label: string; options: string[] }[] = [
  ...
  {
    label: "סוג מנה",
    options: ["עוגות", "פסטה", "מרקים", "סלטים", "עוף"],
  },
  {
    label: "סגנון אוכל",
    options: [
  ...
  {
    label: "רמת חריפות",
    options: ["לא חריף", "חריף קלות", "חריף"],
  },
  {
    label: "רמת קושי",
    options: ["קל להכנה", "רמת קושי בינונית", "מתכון מאתגר"],
  },
  {
    label: "הזדמנות",
    options: ["לשבת וחג", "יום הולדת", "פיקניק"],
  },
  {
    label: "ילדים",
    options: ["מתאים לילדים"],
  },
];
