...
// A single scrollable row of small category shortcuts, user-customizable:
// long-press removes one, "+" at the end opens a picker for adding more from
// the full catalog. Which tiles are shown (and their order) is handed in
...
export function CategoryTiles({
  ...
  for (const tile of availableToAdd) {
    groupedAvailable.set(tile.group, [...(groupedAvailable.get(tile.group) ?? []), tile]);
  }
